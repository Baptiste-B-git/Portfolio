...
.pauseFor(1000)
.deleteChars(5)
.typeString('<span style="color: #FF3B3C;"> HTML</span> !')
.pauseFor(1000)
.deleteChars(6)
.typeString('<span style="color: #FCB900;"> JavaScript</span> !')
.pauseFor(1000)
.deleteChars(13)
.typeString('<span style="color: #27ae60;"> VueJS</span> !')
.pauseFor(1000)
.deleteChars(8)
.typeString('<span style="color: #FD9328;"> Full-stack</span> !')
.start()
...
const soustitreComp = document.querySelector('.soustitre-exp');
...
.from(soustitreComp, {opacity: 0, duration: 0.6})
